...
public:
  ...
  void finalize() {
    ...
    pade_ssaice = real4d(); 
    pade_asyice = real4d(); 
    pade_sizreg_extliq = real1d(); 
    pade_sizreg_ssaliq = real1d(); 
    pade_sizreg_asyliq = real1d(); 
    pade_sizreg_extice = real1d(); 
    pade_sizreg_ssaice = real1d(); 
    pade_sizreg_asyice = real1d(); 
