...
!!
 ...
 end type ty_gas_optics_rrtmgp_type
  ! -------------------------------------------------------------------------------------------------
  !
...
contains
  ...
  pure function get_ngas(this)
    ...
    class(ty_gas_optics_rrtmgp_type), intent(in) :: this
    integer                                        :: get_ngas
  ...
  function compute_gas_taus(this,                       &
    ...
    class(ty_gas_optics_rrtmgp_type), &
                                      intent(in   ) :: this
  ...
  function load_int(this, available_gases, gas_names, key_species,  &
    ...
    class(ty_gas_optics_rrtmgp_type),     intent(inout) :: this
