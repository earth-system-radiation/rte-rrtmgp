...
The cloud optics is highly simplified and just prescribes a single absorption coefficient ($\kappa$), single scattering albedo ($\omega$), and asymmetry factor ($g$) for clouds in the longwave and shortwave, respectively.
