...
# >python ./create_optimal_single_angle_nc.py
# >cp rrtmgp-data-lw-g256-2018-12-04.nc rrtmgp-data-lw-g256-2018-12-04-a.nc
# >ncks -A -v optimal_single_angle_fit sec_t_fit_coeffs.nc
...
optimal_single_angle_fit = \
    dataset.createVariable("optimal_single_angle_fit", "f4",
                           ("bnd", "fit_coeffs"))
optimal_single_angle_fit[:] = dat

optimal_single_angle_fit.description = \
    'Coefficients for linear fit used in longwave \
     optimal single angle RT calculation'
dataset.close()
